...
while True:
    ...
    elif low_tendencie and start and bullish_engulfing['result'][second_candle_index] == True and all_candle_close_five_m[first_candle_index] > all_candle_open_five_m[first_candle_index]:
        print('engolfo de alta')
        win = API.call_decision(balance, value, active, wins, total_candles, stop_loss, otc, mkt, active_index)
    ...
    elif low_tendencie and start and bullish_harami['result'][third_candle_index] == True and all_candle_close_five_m[first_candle_index] > all_candle_open_five_m[first_candle_index]:
    ...
    elif low_tendencie and start and bullish_harami['result'][second_candle_index] == True and all_candle_close_five_m[first_candle_index] > all_candle_open_five_m[first_candle_index]:
        print('harami de alta')
        win = API.call_decision(balance, value, active, wins, total_candles, stop_loss, otc, mkt, active_index)
    ...
    elif low_tendencie and start and hammer['result'][third_candle_index] == True and all_candle_close_five_m[first_candle_index] > all_candle_open_five_m[first_candle_index]:
        print('martelo')
        win = API.call_decision(balance, value, active, wins, total_candles, stop_loss, otc, mkt, active_index)
    ...
    elif low_tendencie and start and hammer['result'][second_candle_index] == True and all_candle_close_five_m[first_candle_index] > all_candle_open_five_m[first_candle_index]:
        print('martelo')
        win = API.call_decision(balance, value, active, wins, total_candles, stop_loss, otc, mkt, active_index)
    ...
    elif low_tendencie and start and inverted_hammer['result'][third_candle_index] == True and all_candle_close_five_m[first_candle_index] > all_candle_open_five_m[first_candle_index]:
    ...
    elif low_tendencie and start and inverted_hammer['result'][second_candle_index] == True and all_candle_close_five_m[first_candle_index] > all_candle_open_five_m[first_candle_index]:
        print('martelo invertido')
        win = API.call_decision(balance, value, active, wins, total_candles, stop_loss, otc, mkt, active_index)
    ...
    elif low_tendencie and start and piercing_pattern['result'][third_candle_index] == True and all_candle_close_five_m[first_candle_index] > all_candle_open_five_m[first_candle_index]:
        print('piercing')
        win = API.call_decision(balance, value, active, wins, total_candles, stop_loss, otc, mkt, active_index)
    ...
    elif low_tendencie and start and piercing_pattern['result'][second_candle_index] == True and all_candle_close_five_m[first_candle_index] > all_candle_open_five_m[first_candle_index]:
        print('piercing')
        win = API.call_decision(balance, value, active, wins, total_candles, stop_loss, otc, mkt, active_index)
    ...
    elif high_tendencie and start and bearish_engulfing['result'][third_candle_index] == True and all_candle_close_five_m[first_candle_index] < all_candle_open_five_m[first_candle_index]:
    ...
    elif high_tendencie and start and bearish_engulfing['result'][second_candle_index] == True and all_candle_close_five_m[first_candle_index] < all_candle_open_five_m[first_candle_index]:
        print('engolfo de baixa')
        win = API.put_decision(balance, value, active, wins, total_candles, stop_loss, otc, mkt, active_index)
    ...
    elif high_tendencie and start and bearish_harami['result'][third_candle_index] == True and all_candle_close_five_m[first_candle_index] < all_candle_open_five_m[first_candle_index]:
    ...
    elif high_tendencie and start and bearish_harami['result'][second_candle_index] == True and all_candle_close_five_m[first_candle_index] < all_candle_open_five_m[first_candle_index]:
        print('harami de baixa')
        win = API.put_decision(balance, value, active, wins, total_candles, stop_loss, otc, mkt, active_index)
    ...
    elif high_tendencie and start and shooting_star['result'][third_candle_index] == True and all_candle_close_five_m[first_candle_index] < all_candle_open_five_m[first_candle_index]:
    ...
    elif high_tendencie and start and shooting_star['result'][second_candle_index] == True and all_candle_close_five_m[first_candle_index] < all_candle_open_five_m[first_candle_index]:
        print('estrela cadente')
        win = API.put_decision(balance, value, active, wins, total_candles, stop_loss, otc, mkt, active_index)
    ...
    elif high_tendencie and start and hanging_man['result'][third_candle_index] == True and all_candle_close_five_m[first_candle_index] < all_candle_open_five_m[first_candle_index]:
        print('enforcado')
        win = API.put_decision(balance, value, active, wins, total_candles, stop_loss, otc, mkt, active_index)
    ...
    elif high_tendencie and start and hanging_man['result'][second_candle_index] == True and all_candle_close_five_m[first_candle_index] < all_candle_open_five_m[first_candle_index]:
        print('enforcado')
        win = API.put_decision(balance, value, active, wins, total_candles, stop_loss, otc, mkt, active_index)
    ...
    elif high_tendencie and start and dark_cloud_cover['result'][third_candle_index] == True and all_candle_close_five_m[first_candle_index] < all_candle_open_five_m[first_candle_index]:
        print('nuvem negra')
        win = API.put_decision(balance, value, active, wins, total_candles, stop_loss, otc, mkt, active_index)
    ...
    elif high_tendencie and start and dark_cloud_cover['result'][second_candle_index] == True and all_candle_close_five_m[first_candle_index] < all_candle_open_five_m[first_candle_index]:
        print('nuvem negra')
        win = API.put_decision(balance, value, active, wins, total_candles, stop_loss, otc, mkt, active_index)
